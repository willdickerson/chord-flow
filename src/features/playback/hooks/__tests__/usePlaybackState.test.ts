...
describe('usePlaybackState', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(audioService.generateChordProgression).mockResolvedValue(mockSequence);
  });
  ...
  it('handles generation error', async () => {
    ...
    vi.mocked(audioService.generateChordProgression).mockRejectedValue(new Error(errorMessage));
