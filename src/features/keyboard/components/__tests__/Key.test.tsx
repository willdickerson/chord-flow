...
describe('Key', () => {
  ...
  it('applies active styles when key is active', () => {
    render(
      <svg>
        <Key {...defaultProps} isActive={true} />
      </svg>
    )
  ...
  it('applies correct dimensions', () => {
    ...
    render(
      <svg>
        <Key {...defaultProps} width={width} height={height} />
      </svg>
    )
  ...
  it('calls mouse event handlers', () => {
    ...
    expect(defaultProps.onMouseEnter).toHaveBeenCalledWith(
      defaultProps.midiNote
    )
